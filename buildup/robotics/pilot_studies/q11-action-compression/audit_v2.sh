...
docker run --rm --name research3-q11-v2-audit --network none --cpus 2 --memory 4g \
 ...
 -v "$PWD/datasets/q11:/inputs:ro" -v "$PWD/runs/q11_v2:/outputs:ro" \
 -v "$q11_audit_output:/audit" \
 sha256:fb9c530b6d664536b7665a3647c28459c729b250e5b1300cc47494820c388b5f python /baseline/audit_v2.py
